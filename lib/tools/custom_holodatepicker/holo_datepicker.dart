...
class _DatePickerWidgetState extends State<HoloDatePicker> {
  ...
  Widget _renderDatePickerItemComponent(int value, String format, double? fontSize) {
    ...
    var itemTextStyle = widget.pickerTheme?.itemTextStyle ?? DATETIME_PICKER_ITEM_TEXT_STYLE;
    if (!widget.isEnabled) {
      itemTextStyle = itemTextStyle.copyWith(color: Theme.of(context).colorScheme.outline);
    }
    return Container(
